    ...
    stages{
        ...
        stage('Deploy AMI'){
            ...
            steps{
                ...
                sh "terraform apply -auto-apprive -var 'aws_accesskey_uswest2=${AWS_ACCESS_KEY_ID}' -var 'aws_secretkey_uswest2=${AWS_SECRET_ACCESS_KEY}' -var 'key_file_uswest2=/home/brianprovenzano/keys/AWS/personal/aws-uswest2-oregon-key.pem' -var 'key_name_uswest2=aws-uswest2-oregon-key' -var 'name=webserver' -var 'ami=${env.NEWAMI}'"
                //echo "This is the AMI from the txt file - trimmed: "
                //sh 'export NEWAMI=$(cat ami.txt | tr -d \'[:space:]\')'
                //sh 'echo ${NEWAMI}'
            }
